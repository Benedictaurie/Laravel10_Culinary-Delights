...
<body class="bg-gray-100">
    ...
    <section class="container mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Product Image -->
            <div>
                <img src="https://www.recipetineats.com/tachyon/2018/12/Strawberry-Cheesecake_8.jpg?resize=900%2C1125&zoom=0.72" alt="Strawberry Cheesecake" class="rounded-lg shadow-lg w-full">
            </div>
            <!-- Product Details  -->
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-4">Strawberry Cheesecake</h1>
                <p class="text-gray-600 mb-4">
                    This is a detailed description of the product. Highlight its key features, benefits, and usage.
                </p>
                <p class="text-2xl font-semibold text-blue-600 mb-4">Rp. 60.000</p>
    ...
    <script>
        ...
        form.addEventListener('submit', (e) => {
            ...
            // Get product details
            const productName = "Strawberry Cheesecake";
            ...
            row.innerHTML = `
                ...
                <td class="border-b px-4 py-2">$${(price * quantity).toFixed(2)}</td>
            `;
